...
export default function Chapter({ chapterNumber, imageUrls, totalChapters, params, errorcode }) {
    ...
    const DESCRIPTION = `Read ${MANGA_NAME} chapter ${chapterNumber} online. Max, finds themselves thrust into a virtual reality game where they quickly reach the maximum level despite being a complete newcomer. Armed with newfound abilities and a fresh perspective, Max navigates a world where experience isn't always the key to success.`
